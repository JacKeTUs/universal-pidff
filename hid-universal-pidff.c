...
static const struct hid_device_id universal_pidff_devices[] = {
	...
	{ HID_USB_DEVICE(USB_VENDOR_ID_SIMAGIC_ALPHA_2, USB_PRODUCT_ID_SIMAGIC_EVO_1),
		.driver_data = HID_PIDFF_QUIRK_SKIP_PID_POOL },
	{ HID_USB_DEVICE(USB_VENDOR_ID_SIMAGIC_ALPHA_2, USB_PRODUCT_ID_SIMAGIC_EVO_2),
		.driver_data = HID_PIDFF_QUIRK_SKIP_PID_POOL },
	{ HID_USB_DEVICE(USB_VENDOR_ID_SIMAGIC_ALPHA_2, USB_PRODUCT_ID_SIMAGIC_EVO_3),
		.driver_data = HID_PIDFF_QUIRK_SKIP_PID_POOL },
